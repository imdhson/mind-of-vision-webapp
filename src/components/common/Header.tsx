  ...
  return (
    <header className="safe-top shrink-0 bg-bg">
      <div className="flex h-9 items-center justify-between px-4">
        <h1 className="text-[14px] font-bold tracking-tight text-fg">Mind of Vision</h1>
        <div className="flex items-center gap-1.5 text-[11px] font-medium text-muted tabular" aria-live="polite">
          <span
            className={cx(
              'inline-block size-1.5 rounded-full',
              detectorStatus === 'ready' && camStatus === 'running' && 'bg-accent',
